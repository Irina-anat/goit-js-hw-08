...
//Під час перезавантаження сторінки скористалась методом setCurrentTime() з метою відновлення відтворення зі збереженої позиції. Встановлюю час, після перезавантаження отриманий з localStorage і перетворений в значення JS
